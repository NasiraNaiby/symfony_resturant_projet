 ...
 */
final class Version20250320141226 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE panier (id INT AUTO_INCREMENT NOT NULL, commands_id INT DEFAULT NULL, quantite INT NOT NULL, plat_prix INT NOT NULL, totale_prix INT NOT NULL, confirmed TINYINT(1) DEFAULT NULL, UNIQUE INDEX UNIQ_24CC0DF2F7982617 (commands_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE panier_plats (panier_id INT NOT NULL, plats_id INT NOT NULL, INDEX IDX_AC674DB7AA14E1C8 (plats_id), INDEX IDX_AC674DB7F77D927C (panier_id), PRIMARY KEY(panier_id, plats_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
